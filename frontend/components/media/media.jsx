      ...
      if(artist) {
        return (
          artist.profilePhotoUrl
            ? <div>
                <div>
                  <img className="artist-profile-photo-image" src={artist.profilePhotoUrl} alt="artist" />
                </div>
        ...
        return (
          album.coverArtUrl
            ? <div>
                <div>
                  <img className="album-cover-art-photo" src={album.coverArtUrl} alt="album" />
                </div>
        ...
        return (
          playlist.playlistPhotoUrl
            ? <div>
                <div>
                  <img className="album-cover-art-photo" src={playlist.playlistPhotoUrl} alt="playlist" />
                </div>
